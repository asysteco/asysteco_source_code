      ...
      echo '<div class="collapse navbar-collapse" id="top-menu">';
        ...
        echo "</ul>";
          ...
          echo "<li class=' $act_guardias '>";
            echo "<a href='$_SERVER[PHP_SELF]?ACTION=guardias'>";
              echo '<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-upc-scan" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
