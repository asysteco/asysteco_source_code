    ...
    <div id="ayuda-formato" style="display: none; border-radius: 10px; padding: 10px; margin: 25px; box-shadow: 4px 4px 16px 0 #808080bf;">
      ...
      <div class="format-body">
        ...
        <?php if (isset($options['edificios']) && $options['edificios'] > 1) {
          echo '<b>EDIFICIO:</b> Número del edificio en el que se impartirá la hora.<br>';
        } ?>
...
3BACHB;AAM;AU214;4;3</pre>';
      ...
      <p class="format-body">Si lo desea, haciendo click al siguiente botón puede descargar una plantilla del formato en CSV:
        <a href="index.php?ACTION=download&OPT=plantilla-horarios"><span style="font-size: 20px;" class="fa fa-cloud-download"></span></a>
      </p>
    </div>
    <br>
    <form action="index.php?ACTION=horarios&OPT=" method="post" name="frmCSVImport" id="frmCSVImport" enctype="multipart/form-data">
      <div class="row">
