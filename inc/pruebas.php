                                    ...
                                    ORDER BY $class->horarios.HORA_TIPO, $class->horarios.Dia"))
{
    if ($response->num_rows > 0)
    {
        ...
        echo "<a id='editar-horario' href='index.php?ACTION=horarios&OPT=edit-horario-profesor&profesor=$n[ID]' class='btn btn-success'> Anterior</a>";
        echo "<a id='editar-horario' href='index.php?ACTION=horarios&OPT=edit-horario-profesor&profesor=$n[ID]' class='btn btn-success'> Siguiente</a>";
